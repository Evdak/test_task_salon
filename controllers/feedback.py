...
@router.get('/all', response_model=List[FeedbackBase])
...
@router.get('/user/{user_id}', response_model=List[FeedbackBase])
...
@router.get('/master/{master_id}', response_model=List[FeedbackBase])
...
@router.get('/id/{id}', response_model=List[FeedbackBase])
...
@router.post('/create', response_model=FeedbackCreate)
...
@router.put('/update', response_model=FeedbackBase)
